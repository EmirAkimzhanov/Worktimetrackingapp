...
import { useGetPIE, useDeletePIE } from '../../../hooks/useRefBooks';
...
export function PieTable({
    ...
    const { data: pies, isLoading, error, refetch } = useGetPIE();
    ...
    const handleConfirmDelete = async () => {
        if (pieToDelete) {
            try {
                await deletePie.mutateAsync(pieToDelete.id);
                await refetch();
    ...
    const safeData = Array.isArray(pies) ? pies : [];
        ...
        return (
            <div className="space-y-4">
                <div className="flex items-center justify-between">
                    <div>
                        <h2 className="text-xl font-bold tracking-tight">Pies</h2>
                        <p className="text-sm text-muted-foreground">Manage all pies in the collection</p>
                    </div>
            ...
            <div className="space-y-4">
                                ...
                                <TableRow>
                                    <TableCell colSpan={3} className="text-center text-slate-500 py-8">
                                        <div className="flex flex-col items-center gap-2">
                                            ...
                                            <span>No pies found. Click "Add Pie" to create your first pie.</span>
                                        </div>
                                    </TableCell>
                                </TableRow>
                            ) : (
                ...
                {deleteDialogOpen && (
                    <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                <AlertDialogTitle>Delete Pie?</AlertDialogTitle>
