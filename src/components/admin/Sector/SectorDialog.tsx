...
import { useCreatePIE, useUpdatePIE, useGetPIE, useCreateSector, useUpdateSector, useGetSector } from '../../../hooks/useRefBooks';
...
export function SectorDialog({
    ...
    const { refetch: refetchSector } = useGetSector();
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            ...
            >
                <DialogHeader>
                    <DialogTitle>
                        {editingPie ? 'Edit Sector' : 'Add Sector'}
                    </DialogTitle>
